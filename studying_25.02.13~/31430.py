...
# 예제 출력 1 
# aaaaaaaathree
# 문제의 이해를 돕기 위한 예시다. 먼저 갑에게 입력으로 정수 $A$와 $B$의 값이 각각 $1$과 $2$로 주어진 것을 보여준다. 이후 갑은 소문자 알파벳으로 구성된 길이가 $13$인 문자열 aaaaaaaathree을 출력하였다.
...
# 예제 출력 2 
# 3
# 이어서 예제 입력 1에서 갑이 출력한 aaaaaaaathree이 을의 입력으로 주어진다. 위에서 설명한 것과 같이 소문자 알파벳으로 구성된 길이가 $13$인 문자열이 주어진 것을 알 수 있다.
